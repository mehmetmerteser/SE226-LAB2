words = ["a", "ability", "able", "about", "above", "accept", "according", "account", "across", "act", "action",
         ...
         "buy", "by",
         "call", "camera", "campaign", "can", "cancer", "candidate", "capital", "car", "card", "care", "career",
         "carry", "case", "catch", "cause", "cell", "center", "central", "century", "certain", "certainly", "chair",
         "challenge",
         "chance", "change", "character", "charge", "check", "child", "choice", "choose", "church", "citizen", "city",
...
print("********************************************************* \n")
print("The words starts with letter ha: \n")
...
for a in range(1, numberinput + 1):
    print('*' * a)


for a in range(numberinput - 1, 0, -1):
    print('*' * a)
